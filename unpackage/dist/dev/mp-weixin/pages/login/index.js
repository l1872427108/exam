...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/login/index.vue */ 83));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
//
//
var SumitButton = function SumitButton() {__webpack_require__.e(/*! require.ensure | components/SumitButton/index */ "components/SumitButton/index").then((function () {return resolve(__webpack_require__(/*! ../../components/SumitButton */ 167));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);}; // 倒计时时长(秒)
var times = 60; // 表单验证场景
var LOGIN_STATUS = 1;var REG_STATUS = 2;var _default = { components: { SumitButton: SumitButton }, data: function data() {return { // 加载中
      ...
      loginData: { mobile: '15235985339', //手机号码
        password: 'gl1234' //密码
      }, // 注册表单数据
      ...
      times: times };}, onLoad: function onLoad() {}, methods: { /**
                                                                  ...
                                                                  */validteMobile: function validteMobile(str) {if (Validate.isEmpty(str)) {this.$toast('请先输入手机号');return false;}console.log(Validate.isMobile(str));if (!Validate.isMobile(str)) {this.$toast('请输入正确格式的手机号');return false;}return true;}, /**
                                                                                                                                                                                                                                                                                                            * 验证密码
                                                                                                                                                                                                                                                                                                            */validtePassword: function validtePassword(str) {if (Validate.isEmpty(str)) {this.$toast('请先输入密码');return false;}return true;}, /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                    * 点击登录
                                                                                                                                                                                                                                                                                                                                                                                                                                                    */
