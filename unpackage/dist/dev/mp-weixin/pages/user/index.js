...
/* harmony import */ var _index_vue_vue_type_template_id_137d5072___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=137d5072& */ 43);
...
var AvatarImage = function AvatarImage() {__webpack_require__.e(/*! require.ensure | components/AvatarImage/index */ "components/AvatarImage/index").then((function () {return resolve(__webpack_require__(/*! @/components/AvatarImage */ 145));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var BottomView = function BottomView() {__webpack_require__.e(/*! require.ensure | components/BottomView/index */ "components/BottomView/index").then((function () {return resolve(__webpack_require__(/*! @/components/BottomView */ 152));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var UserToolItem = function UserToolItem() {__webpack_require__.e(/*! require.ensure | pages/user/components/UserToolItem */ "pages/user/components/UserToolItem").then((function () {return resolve(__webpack_require__(/*! ./components/UserToolItem */ 157));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { AvatarImage: AvatarImage, BottomView: BottomView, UserToolItem: UserToolItem }, props: { isLogin: { type: Boolean, default: false } }, data: function data() {return { // 主题颜色
      ...
      studentInfo: _user2.User.data };}, /**
                                                * 声命周期--监听页面显示
                                                */created: function created() {this.onRefreshPage();}, /**
                                                                                                        * 监听--用户状态发生改变
      ...
      this.getPageData();}, /**
                             * 获取当前用户信息
                             */getUserInfo: function getUserInfo() {var _this = this;return new Promise(function (resolve, reject) {console.log('qqqq', _this.isLogin);!_this.isLogin ? resolve(null) : UserApi.getUserInfo({}, { load: _this.isFirstload }).then(function (result) {console.log('result', result);_this.userInfo = result.data.qskInfo;resolve(_this.userInfo);}).catch(function (err) {reject(err);});});}, /**
                                                                                                                                                                                                                                                                                                                                                                                                                               * 获取页面数据
                                                                                                                                                                                                                                                                                                                                                                                                                               */
    getPageData: function getPageData(callback) {var _this2 = this;
      this.isLoading = true;
      this.getUserInfo().
      then(function () {
      ...
      finally(function () {return _this2.isLoading = false;});
    },
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/user/index.vue */ 42));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
