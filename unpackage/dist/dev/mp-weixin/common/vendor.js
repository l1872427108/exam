...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"轻松考","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 10:
/*!*************************************************************!*\
  !*** /Users/renchengkai/Desktop/project-qsk/store/index.js ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _getters = _interopRequireDefault(__webpack_require__(/*! ./getters */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 12:
/*!***************************************************************!*\
  !*** /Users/renchengkai/Desktop/project-qsk/store/getters.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var getters = {
  token: function token(state) {return state.users.token;} };var _default =
...
/***/ 13:
/*!***********************************************************************!*\
  !*** /Users/renchengkai/Desktop/project-qsk/store/modules sync \.js$ ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
{ id: 4, title: '固定试卷' },
{ id: 5, title: '班级试卷' },
{ id: 6, title: '系级试卷' }]);exports.default = _default;
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * 登录成功后执行方法
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */
var loginSuccess = function loginSuccess(commit, _ref) {var token = _ref.token;
  var expiryTime = 30 * 86400;
  // storage.set('userId', userId, expiryTime)
  _storage.default.set('AccessToken', token, expiryTime);
  commit(_mutationTypes.SET_TOKEN, token);
...
_mutationTypes.SET_TOKEN, function (state, value) {
  console.log('value=>', value);
  state.token = value;
  console.log('token=>', state.token);
}), _defineProperty(_mutations,
_mutationTypes.SET_USER_ID, function (state, value) {
  state.userId = value;
}), _mutations);
...
var actions = {
  /**
                 ...
                 * 手机号和密码
                 */
  login: function login(_ref2, data) {var commit = _ref2.commit;
    console.log(data);
    return new Promise(function (resolve, reject) {
      LoginApi.login(data).
  ...
  /**
      * 退出登录
      */
  logout: function logout(_ref3, data) {var commit = _ref3.commit;
    var store = this;
    return new Promise(function (resolve, reject) {
      if (store.getters.token) {}
      _storage.default.remove('AccessToken');
      commit(_mutationTypes.SET_TOKEN, '');
      resolve();
    });
  } };var _default =
...
function register(data) {
  return _request.default.post(api.register, data);
}
...
function sendCode(phone) {
  return _request.default.get("".concat(api.code, "/").concat(phone));
}

/**
   * 获取用户信息
   */
function getUserInfo(param, option) {
  var options = _objectSpread({
    isPrompt: false,
    load: false },
  option);

  return _request.default.get(api.info, param, options);
}
...
function updateUserInfo(data) {
  return _request.default.put(api.update, data);
}
...
$http.requestStart = function (options) {
  ...
  // 请求前加入Token
  options.header['token'] = _store.default.getters.token;
...
$http.dataFactory = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var httpData;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            ...
            httpData === false || typeof httpData !== 'object')) {_context.next = 8;break;}return _context.abrupt("return",

            Promise.reject({
              statusCode: res.response.statusCode,
              errMsg: "请检查api地址能否访问正常" }));case 8:if (!(
            ...
            httpData.code == 20000)) {_context.next = 10;break;}return _context.abrupt("return",
...
$http.requestError = function (e) {
  if (e.statusCode === 0) {
    ...
    setTimeout(function () {return showRequestError(e);}, 10);
  }
};
...
exports.qiniuUpload = qiniuUpload;var urlUpload = function urlUpload(requestInfo, dataFactory) {
  return new Promise(function (resolve, reject) {
    ...
    if (Array.isArray(requestInfo.files)) {var
      ...
      //
      // #-ifdef MP
      var len = requestInfo.files.length - 1;var fileList = new Array();fileUpload(0);} else {reject({ errMsg: "files 必须是数组类型",
        statusCode: 0 });
                                                                               ...
                                                                               */var _default =
{
  ...
  // 获取指定配置
  get: function get(key) {var def = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
...
var checkLogin = function checkLogin() {
  console.log('store.getters.token', _store.default.getters.token);
  return !!_store.default.getters.token;
};
...
var navTo = function navTo(url) {var query = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var modo = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'navigateTo';
  if (!url || url.length == 0) {
    return false;
  }
  // 生成query参数
...
var addUnit = function addUnit() {var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'auto';var unit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'rpx';
  value = String(value);
  return (0, _validate.isNumber)(value) ? "".concat(value).concat(unit) : value;
};
...
var addPreZero = function addPreZero(num) {
  var s = "";
  if (num < 10) {
    s = '0';
  }
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.isUsername = isUsername;exports.isPassword = isPassword;exports.isNoteCode = isNoteCode;exports.isEmail = isEmail;exports.isDouble = exports.isInteger = exports.isPositiveInteger = exports.isNumber = exports.isMobile = exports.isEmpty = void 0;
...
function isPassword(str) {
  var valid = /^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,}$/;
...

{
  key: 'userNum',
  name: '学号',
  color: 'text-red' }]);exports.default = _default;
...
Enum = /*#__PURE__*/function () {
  function Enum(param) {_classCallCheck(this, Enum);
    ...
    // 防止被修改
    Object.freeze(this);
  }_createClass(Enum, [{ key: "getData", value: function getData()

    {
      return this.data;
    } }]);return Enum;}();var _default =


Enum;exports.default = _default;
  ...
  name: '幽静' },
{
  ...
  name: '天空' }]);exports.default = _default;
...

{
  ...
  img: '/static/tabBar/me.png' }]);exports.default = _default;
...
'软工（专升本）2101',
'软工（专升本）2102',
'软工（专升本）2103']);exports.default = _default;
...
{
  value: '女',
  name: '女' }]);exports.default = _default;

/***/ }),

/***/ 9:
/*!***************************************************************!*\
  !*** /Users/renchengkai/Desktop/project-qsk/utils/storage.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni) {var postfix = '_expiry'; // 缓存有效期后缀   
...
/**
                                                                * 获取所有考卷
                                                                */
function getAllExamInfo() {
  return _request.default.get(api.exam);
}
...
/**
   * 查询考试记录
   */
function selectAllExamPaperAnswer() {
  return _request.default.get(api.answer);
}
...
/**
   * 开始答题，根据试卷id查询试卷详情
   */
function getOneExamPaper(param) {
  return _request.default.get(api.paper, param);
}

/**
   * 提交试卷
   */
function subimtExamAnswer(data) {
...
/**
   * 查看考试记录
   */
function getExamPaperUserAnswer(id) {
  return _request.default.get("".concat(api.recode, "/").concat(id));
}
